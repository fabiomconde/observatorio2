    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.URLField(help_text='URL pública do dashboard, ex: http://painel.provaconceito.tech/superset/dashboard/p/xOY1wMmwkZP/?standalone=1', max_length=500, verbose_name='link / URL do iframe')),
